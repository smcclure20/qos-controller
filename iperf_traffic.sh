...
iperf3 -c 10.4.0.5  -t 100 -S 0x0C -b 110K --logfile results/prio2.out -p 5022 &

# Reach high priority limit (128K) [one of these should be admitted]
echo "3kbps to 5023 and 3kbps to 5024"
iperf3 -c 10.4.0.5  -t 100 -S 0x08 -b 3K --logfile results/prio3.1.out -p 5023
echo "Sleep for 2"
sleep 2
iperf3 -c 10.4.0.5  -t 100 -S 0x08 -b 3K --logfile results/prio3.2.out -p 5024 &

# Should be low priority
echo "100kbps to 5025"
iperf3 -c 10.4.0.5  -t 100 -S 0x14 -b 100K --logfile results/prio4.out -p 5025
echo "Test Complete"
