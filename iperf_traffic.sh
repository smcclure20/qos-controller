...
iperf3 -c 10.4.0.5  -t 100 -S 0x05 -b 110K --logfile results/prio2.out -p 5022 &

# Reach high priority limit (128K) [one of these should be admitted]
iperf3 -c 10.4.0.5  -t 100 -S 0x06 -b 3K --logfile results/prio3.1.out -p 5023
sleep 2
iperf3 -c 10.4.0.5  -t 100 -S 0x06 -b 3K --logfile results/prio3.2.out -p 5024 &

# Should be low priority
iperf3 -c 10.4.0.5  -t 100 -S 0x07 -b 200K --logfile results/prio4.out -p 5025
echo "Test Complete"
